"""
Django settings for HealthMapper project.
...
SECRET_KEY = '45glCoNam2bJC2dYoioiKS9W7tPxk53u'
...
INSTALLED_APPS = [
    ...
    'leaflet', # Leaflet integration with Django admin panel and templates
...
WSGI_APPLICATION = 'HealthMapper.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'postgres.tpiagcexddntgxplotbt',
...
# Leaflet settings
LEAFLET_CONFIG = {
    'DEFAULT_CENTER': (-0.0917, 34.7675),
    'DEFAULT_ZOOM': 12,
    'MIN_ZOOM': 5,
    'MAX_ZOOM': 18,
    'SCALE': 'metric',
    'ATTRIBUTION_PREFIX': 'HealthMapper © <a href="https://github.com/AROGO-123/HealthMapper">AROGO-123</a>',
